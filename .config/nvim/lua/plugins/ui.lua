return {
...

  {
    ...
    keys = {
      ...
      { "<leader>bn", "<CMD>BufferNext<CR>",         mode = {"n"}, desc = "[Buffer] Next buffer"       },
      { "<leader>bp", "<CMD>BufferPrevious<CR>",     mode = {"n"}, desc = "[Buffer] Previous buffer"   },
      { "<leader>bf", "<CMD>BufferFirst<CR>",        mode = {"n"}, desc = "[Buffer] First buffer"      },
      { "<leader>bl", "<CMD>BufferLast<CR>",         mode = {"n"}, desc = "[Buffer] Last buffer"       },
      ...
      { "<leader>br", function() vim.ui.input({ prompt = "Rename buffer: " }, function(name) if name then vim.cmd("file " .. name) end end) end, mode = {"n"}, desc = "[Buffer] Rename buffer" },
      { "<leader>bc", "<CMD>BufferClose<CR>",        mode = {"n"}, desc = "[Buffer] Close buffer"      },
      { "<leader>bC", "<CMD>BufferCloseAllButCurrent<CR>", mode = {"n"}, desc = "[Buffer] Close all but current" },
      { "<leader>bP", "<CMD>BufferPin<CR>",          mode = {"n"}, desc = "[Buffer] Pin/Unpin buffer"  },
      { "<leader>bo", "<CMD>BufferOrderByDirectory<CR>", mode = {"n"}, desc = "[Buffer] Order by directory" },
    },
    opts = {
      animation = false,
...

  {
    ...
    keys = {
      ...
      { "<ESC>", "<Cmd>noh<CR>",                               mode = "n", desc = "Clear highlight", noremap = true, silent = true },
